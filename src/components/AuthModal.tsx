        ...
        <div className="p-6">
          ...
          <div className="flex bg-secondary-100 rounded-lg p-1 mb-6">
            <button
              ...
              className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-all ${
                activeTab === 'login' 
                  ? 'bg-white shadow-sm text-secondary-800 border border-gold-200' 
          ...
          <div className="flex bg-secondary-100 rounded-lg p-1 mb-6">
            <button
              ...
              className={`flex-1 py-2 px-4 rounded-md flex items-center justify-center space-x-2 text-sm font-medium transition-all ${
                authMethod === 'email' 
                  ? 'bg-white shadow-sm text-secondary-800 border border-gold-200' 
                  : 'text-secondary-600 hover:text-secondary-800'
              }`}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full pl-10 pr-3 py-3 border border-silver-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gold-500 focus:border-transparent transition-all"
            ...
            {showOTP && authMethod === 'phone' && (
              <div>
                <label className="block text-sm font-medium text-secondary-700 mb-2">Enter OTP</label>
                <input
                  type="text"
                  name="otp"
                  value={formData.otp}
                  onChange={handleInputChange}
                  required
                  className="w-full px-3 py-3 border border-silver-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gold-500 focus:border-transparent transition-all"
          ...
          <div className="mt-6">
            <div className="relative">
              <div className="absolute inset-0 flex items-center">
                <div className="w-full border-t border-silver-300" />
              </div>
            ...
            <div className="mt-6 grid grid-cols-3 gap-3">
              <button
                ...
                className="w-full inline-flex justify-center py-3 px-4 border border-silver-300 rounded-lg shadow-sm bg-white text-sm font-medium text-secondary-500 hover:bg-gold-50 hover:border-gold-300 transition-colors"
              >
